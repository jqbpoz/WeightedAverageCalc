...
class Data {
    ...
    _createArr() {
        for(let i = 0; i < dataValuesAll.length; i++)this.dataArr.push([
...
class App {
    ...
    _newData() {
        ...
        if (newData.result === "no data") return;
    ...
    _getCurrentPosition(e) {
        ...
        requestAnimationFrame(function() {
            if (e.target.tagName === "INPUT") e.target.setSelectionRange(textLength, textLength);
        });
    ...
    _switchByArrows(e) {
        ...
        switch(e.key){
            case "ArrowLeft":
                ...
                document.querySelector(`[data-id="${this.#currentPosition - 1}"]`)?.focus();
                break;
            case "ArrowUp":
                document.querySelector(`[data-id="${this.#currentPosition - 2}"]`)?.focus();
                break;
            case "ArrowRight":
    ...
    _addRow() {
        ...
        dataWeightsAll[lastIndex / 2 - 1].closest(".data__row").insertAdjacentHTML("afterend", `<div class="data__row">
      <div class="data__number">${lastIndex / 2 + 1}</div>
      <input type="text" data-id="${lastIndex + 1}" class="data__value data__input" />
      <input type="text" data-id="${lastIndex + 2}" class="data__weight data__input" />
    </div>`);
...
const app = new App(); // dataEl.addEventListener("focusin", function (e) {
